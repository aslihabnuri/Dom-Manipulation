# Caption TikTok — `250726TB_03_Coming_Soon.mp4`

Video: 1440 × 2560 (9:16), 7,2 detik, monokrom, tanpa narasi.
Urutannya: logo → `COMING SOON` → boxer longgar → logo → singlet putih dengan boxer brief → `COMING SOON` → boxer brief dengan logo → `COMING SOON` → logo.
...
Sisanya justru menguntungkan. Kalimat kunci brand di hal. 28 berbunyi *"It's not about standing out loudly."* Di feed yang semuanya berteriak, caption yang tenang **memang** lebih menonjol. Nada brand ini bukan hambatan di TikTok, itu pembedanya.
...
Videonya HEVC di container QuickTime, 1440 × 2560. TikTok menerima keduanya dan akan meng-encode ulang sendiri, jadi tidak perlu dikonversi. Berbeda dengan Shopee, yang menolak kombinasi itu.
