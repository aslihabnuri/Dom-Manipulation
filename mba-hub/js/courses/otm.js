...
window.MBA_COURSES.otm = {
  meta: {
    ...
    hasBook: true,
    tools: ["productivity"],
    driveFolder: "https://drive.google.com/drive/folders/1DVhVYPHvsV4JwgEgF-oZDrzX3uUF7QAn",
    status: "Materi Sesi 1 & 2 lengkap"
  },
  course: {
      ...
      summary: [
        {
          ...
          questions: [{"q": "Di kasus Hard Rock Cafe, menu baru hanya masuk produksi bila bahannya tersedia dari pemasok yang qualified. Dalam praktik di Indonesia, bagaimana perusahaan sebaiknya menyeimbangkan kecepatan meluncurkan produk baru dengan kesiapan pemasok? Apakah pernah ada kasus di mana menunggu pemasok justru membuat kehilangan momentum pasar?", "guide": "Mengapa menarik: menghubungkan kasus pembuka kuliah dengan dilema nyata speed vs quality di keputusan supply chain. Dosen Anda berlatar industrial engineering, sehingga kemungkinan besar memiliki contoh riset atau industri nyata. Follow-up: 'Apa kriteria minimum pemasok yang tidak boleh dikompromikan?'"}, {"q": "Materi membagi operasi berdasarkan input dominannya: material, informasi, atau pelanggan. Untuk bisnis hybrid seperti bank digital atau rumah sakit dengan telemedicine, yang memproses informasi sekaligus pelanggan, mana yang sebaiknya dijadikan acuan utama desain operasinya?", "guide": "Mengapa menarik: menguji batas kerangka Tabel 1.2 pada bisnis kontemporer yang tidak rapi masuk satu kategori. Ini pertanyaan konseptual yang menunjukkan Anda membaca materi sampai implikasinya. Follow-up: 'Apakah pergeseran layanan ke digital berarti semua operasi bergerak menjadi pemroses informasi?'"}, {"q": "Kalau prinsip OM berlaku untuk semua fungsi (operations as activity), mengapa dalam struktur organisasi kebanyakan perusahaan Indonesia, direktur operasi justru jarang duduk setara CFO/CMO di pengambilan keputusan strategis? Apakah ini masalah persepsi terhadap fungsi operasi?", "guide": "Mengapa menarik: mengangkat ketegangan antara teori (OM fundamental) dan realita organisasi. Tema yang biasanya memancing dosen bercerita pengalaman industri. Follow-up: 'Apa yang harus dilakukan profesional operasi agar suaranya lebih strategis?'"}],
...
pemasok yang berkualitas. Proses produksinya, dari penerimaan bahan, penyimpanan dingin, memanggang, sampai penyajian, dirancang dan dijaga agar menghasilkan makanan berkualitas. Di balik itu semua ada manajer yang menyusun jadwal karyawan
dan merancang layout dapur yang efisien. <strong>Semua aktivitas itulah yang disebut operations management.</strong></p>
<h4 class="sub-h">Dua definisi kunci yang perlu dikuasai</h4>
...
<h4 class="sub-h">Mengapa mata kuliah ini penting bagi Anda</h4>
...
berlaku di semua fungsi bisnis, bukan hanya di pabrik.</div>`
        ...
        {
          heading: "The Four Vs",
          questions: [{"q": "hotelF1 sukses dengan menekan visibility serendah mungkin demi biaya. Namun tren 'experience economy' mendorong pelanggan justru ingin melihat dan terlibat dalam proses (open kitchen, live barista). Apakah strategi menekan visibility semakin berisiko sekarang, atau kedua tren ini melayani segmen yang memang berbeda?", "guide": "Mengapa menarik: mempertemukan kerangka klasik 4V dengan tren konsumen terkini, mengundang dosen mengomentari apakah teorinya perlu adaptasi. Follow-up: 'Apakah ada industri di mana menaikkan visibility justru menurunkan biaya, misalnya karena pelanggan ikut bekerja (self-service)?'"}, {"q": "Adakah contoh perusahaan Indonesia yang berhasil berpindah posisi 4V secara signifikan, misalnya dari volume rendah-variety tinggi menjadi volume tinggi-variety rendah, tanpa kehilangan pelanggan lamanya? Apa yang membuat transisi seperti itu berhasil atau gagal?", "guide": "Mengapa menarik: meminta contoh lokal dari pengalaman/riset dosen, bukan dari buku, jenis pertanyaan yang menghidupkan kelas. Kandidat diskusi: warung yang jadi waralaba, katering rumahan yang masuk industri. Follow-up: 'Fase mana yang paling berbahaya dalam transisi itu?'"}],
          source: { kind: "ppt", label: "Slide Pertemuan 1" },
...
<h4 class="sub-h">Empat dimensi 4V satu per satu</h4>
<ul>
...
sesuai permintaan penumpang. Bus kota variety-nya rendah: rutenya tetap. Semakin banyak variasi yang ditawarkan,
semakin kompleks dan mahal operasinya.</li>
...
<h4 class="sub-h">Kaitan keempat dimensi dengan struktur biaya</h4>
...
<p>Slide "A typology of operations and processes" memerinci apa konsekuensi posisi rendah vs tinggi di tiap dimensi. Perhatikan bagaimana ujung kanan (kolom kedua) selalu bermuara pada <em>biaya unit rendah</em>:</p>
<ul>
...
<li><strong>Designing</strong>: merancang produk/jasa dan prosesnya, yaitu menentukan bentuk fisik, komposisi, dan cara
...
<ul>
<li><strong>Cost Focus, era Early Concepts (1776–1880):</strong> spesialisasi tenaga kerja (Adam Smith, Babbage) dan
...
<li><strong>Quality Focus, era Lean Production (1980–1995):</strong> Just-in-Time, Computer-Aided Design, Electronic
Data Interchange, Total Quality Management, Baldrige Award, pemberdayaan karyawan, kanban.</li>
<li><strong>Customization Focus, era Mass Customization (1995–2005):</strong> internet & e-commerce, Enterprise
...
<li><strong>Globalization Focus, era Globalization (2005–2020):</strong> rantai pasok global, tumbuhnya organisasi
...
[[slide:25|Figure 1.4, significant events in OM, lima era lengkap dengan tokoh dan inovasinya]]
...
harus terus berdialog dengan marketing, pengembangan produk, dan fungsi-fungsi pendukung.</div>`
        },
        {
          ...
          questions: [{"q": "Walmart menggabungkan jual-langsung dengan marketplace. Gojek menggabungkan on-demand, ecosystem, subscription, sekaligus memonetisasi data. Apakah ada titik di mana mengombinasikan terlalu banyak model bisnis digital justru saling mengkanibal atau mengaburkan positioning, dan bagaimana operasi mengelola kompleksitas itu?", "guide": "Mengapa menarik: naik satu level dari 'apa itu tiap model' (yang ada di slide) ke 'bagaimana mengelola kombinasinya' (yang tidak ada di slide). Follow-up: 'Dari sisi operasi, model mana yang paling berat infrastrukturnya?' Cocok ditanyakan tepat setelah dosen selesai menjelaskan kedelapan model."}, {"q": "Pada model Free, 'customer is the product', data dan perhatian pelanggan yang dijual. Dengan berlakunya UU Perlindungan Data Pribadi di Indonesia, apakah model ini masih berkelanjutan di sini, atau perusahaan digital Indonesia harus mulai migrasi ke subscription/freemium?", "guide": "Mengapa menarik: mempertemukan materi kuliah dengan regulasi Indonesia terkini, menunjukkan Anda berpikir sebagai praktisi, bukan penghafal. Follow-up: 'Model mana yang paling tahan regulasi privasi dalam jangka panjang?'"}, {"q": "Slide menyebut COVID mempercepat transformasi digital 3–4 tahun. Namun banyak transformasi yang dipaksakan pandemi itu kabarnya ditinggalkan lagi setelah situasi normal. Dari pengamatan Ibu, transformasi digital 'darurat' seperti apa yang bertahan, dan seperti apa yang kembali mundur. Apa pembedanya?", "guide": "Mengapa menarik: menguji klaim slide dengan fenomena nyata pasca-pandemi (hybrid working dibatalkan, layanan online ditutup). Jawabannya kemungkinan menyentuh poin kunci slide: yang bertahan adalah yang mengubah proses & budaya, yang mundur adalah yang sekadar memasang alat. Follow-up: 'Bagaimana mengukur kesiapan budaya sebelum transformasi?'"}],
          source: { kind: "ppt", label: "Slide Pertemuan 1" },
...
<em>budaya</em>, bukan sekadar teknologi. Ini poin yang sering dilewatkan orang.</p>
...
mencapai tujuannya menggunakan teknologi digital seperti website, media sosial, dan perangkat mobile? Perusahaan dengan model
...
teknologi, tetapi <strong>memanfaatkannya lebih awal dan lebih efisien daripada kompetitor</strong>.</p>
...
oleh orang yang punya waktu tetapi butuh uang.</span><em>Uber · Taskrabbit (di Indonesia: Gojek/Grab)</em></div>
...
<div class="dbm-card"><b>Ecosystem</b><span>Pelanggan dijual rangkaian produk/jasa yang saling terkait, semakin banyak
yang dimiliki, semakin tinggi nilai keseluruhannya.</span><em>Apple · Google</em></div>
</div>
...
(contoh Walmart), dan gagal bila hanya "memasang alat baru" tanpa mengubah proses dan orangnya.</div>`
        },
        {
          ...
          questions: [{"q": "Materi menyebut dependability dalam jangka panjang bisa mengalahkan semua kriteria lain. Namun di pasar Indonesia yang sangat sensitif harga, konsumen tampak selalu kembali ke yang termurah. Apakah supremasi dependability itu berlaku universal, atau ada prasyarat tingkat pendapatan/kematangan pasar?", "guide": "Mengapa menarik: menantang klaim buku dengan konteks lokal secara sehat. Diskusi 'kapan teori berlaku' selalu lebih dalam daripada 'apa teorinya'. Contoh untuk diskusi: KRL/kurir yang naik kelas karena konsistensi vs perang harga e-commerce. Follow-up: 'Di segmen B2B apakah jawabannya berbeda?'"}, {"q": "Polar diagram membandingkan prioritas objectives antar-operasi, tetapi sifatnya statis. Dalam praktik, apakah perusahaan sebaiknya meninjau ulang profil polar-nya secara berkala, dan apa sinyal bahwa profil yang selama ini dipakai sudah tidak cocok dengan pasar?", "guide": "Mengapa menarik: mengubah alat deskriptif di slide menjadi alat manajemen hidup. Pertanyaan praktis yang dosen teknik industri biasanya senang jawab. Jembatan ke konsep PLC: profil bergeser mengikuti fase produk. Follow-up: 'Siapa di organisasi yang seharusnya memiliki polar diagram ini?'"}],
          source: { kind: "ppt", label: "Slide Pertemuan 1" },
...
Dalam praktik, organisasi memakai ukuran dari ketiga level sekaligus. Dan karena setiap kelompok stakeholder, pemegang saham, karyawan, pelanggan, masyarakat, punya tujuan yang kadang saling bertentangan, adalah tanggung jawab
...
laba-laba di bawah) adalah cara visual menggambarkan kepentingan relatif tiap objective: semakin jauh garis dari pusat,
semakin penting objective itu. Contoh slide: <em>taksi</em> menonjol di speed dan flexibility (antar ke mana saja,
...
operations agility) yang merepresentasikan kinerja keseluruhan, dan sebaliknya bisa dipecah semakin rinci untuk
dimonitor semakin sering.</p>
[[slide:31|corong tiga level kinerja operasi: societal (triple bottom line) → strategic → operational]]
<h4 class="sub-h">Stakeholder operasi dan kepentingan masing-masing</h4>
...
biaya). Prioritasnya berbeda antar-operasi (polar diagram) dan saling tarik-menarik (trade-off, efficient frontier).</div>`
        },
        {
          ...
          questions: [{"q": "Di kasus Starbucks, menghemat 8–14 detik per transaksi menaikkan produktivitas 27%. Namun kafe justru menjual suasana dan pengalaman, di titik mana perburuan detik mulai merusak nilai yang dijual? Bagaimana operasi menentukan batas antara efisiensi dan erosi pengalaman pelanggan?", "guide": "Mengapa menarik: ini ketegangan inti kasus Starbucks yang slide-nya tidak bahas, efisiensi vs experience. Perhatikan detailnya: yang dipangkas Starbucks adalah waktu yang tidak bernilai bagi pelanggan (menunggu tanda tangan), bukan interaksi baristanya. Follow-up: 'Apakah ada kerangka formal untuk memilah aktivitas yang boleh dipangkas, semacam value-added analysis di sisi layanan?'"}, {"q": "Kasus Collins Title menunjukkan labor productivity naik 75% tetapi multifactor hanya 26%. Dua angka yang bisa menceritakan kisah berbeda ke manajemen. Dalam evaluasi investasi teknologi yang sesungguhnya, angka mana yang sebaiknya menjadi dasar keputusan akhir, dan bagaimana memasukkan dampak yang tak terukur seperti kualitas layanan atau kelelahan staf?", "guide": "Mengapa menarik: mengangkat kasus hitungan di slide ke level keputusan manajerial, dan menyentuh keterbatasan pengukuran, wilayah yang dekat dengan riset dosen. Follow-up: 'Pernahkah Ibu menemui kasus di mana produktivitas naik di atas kertas tetapi kinerja bisnis turun?'"}, {"q": "Untuk pekerja pengetahuan (konsultan, peneliti, bahkan dosen) output-nya sulit dihitung per unit. Ukuran produktivitas apa yang adil untuk knowledge workers, dan apakah memaksakan metrik kuantitatif justru menurunkan kualitas kerjanya?", "guide": "Mengapa menarik: pertanyaan yang relevan untuk hampir semua mahasiswa MBA (mayoritas knowledge workers) dan menyinggung profesi dosen. Biasanya mengundang jawaban jujur dan diskusi hangat. Kaitannya ke materi: keterbatasan single-factor productivity di sektor jasa."}],
          source: { kind: "ppt", label: "Slide Pertemuan 1" },
...
<em>labor productivity</em> = unit yang diproduksi ÷ jam kerja (labor-hours). Mudah dihitung, tetapi hanya memotret
satu sisi.</li>
<li><strong>Multifactor productivity</strong> (disebut juga <em>total factor productivity</em>), menghitung <em>semua</em> input: Output ÷ (Labor + Material + Energy + Capital + Miscellaneous). Karena inputnya beragam,
semuanya dikonversi ke satuan uang. Lebih rumit, tetapi jauh lebih jujur.</li>
</ul>
...
gaji tetap sama, tetapi bisa memproses <strong>14 titel per hari</strong>: dengan overhead naik menjadi $800/hari.
...
<p><strong>Insight:</strong> Kedua ukuran menunjukkan kenaikan, tetapi perhatikan selisihnya: 75% berbanding 26%. Ukuran multifactor
...
<h4 class="sub-h">Studi kasus singkat: Starbucks</h4>
<p>Produktivitas bukan sekadar soal mesin mahal. Sering kali soal detik-detik kecil. Tim 10 analis Starbucks terus
...
mudah tetapi parsial; multifactor (semua input dalam dolar) lebih lengkap dan lebih jujur. Untuk ujian: hafalkan langkah
...
persentase perubahan dengan (baru − lama) ÷ lama.</div>`
        },
        {
          ...
          questions: [{"q": "Kalau perspektif outside-in dan inside-out menunjuk arah berbeda. Pasar menuntut murah, sementara kapabilitas kita justru di kustomisasi premium, perspektif mana yang seharusnya menang? Apakah ada urutan prioritas di antara keempat perspektif, atau rekonsiliasinya selalu kasus-per-kasus seperti Micraytech?", "guide": "Mengapa menarik: slide menyatakan 'keempatnya harus direkonsiliasi' tetapi tidak menjelaskan bagaimana caranya saat mereka bertabrakan. Itu celah diskusi yang tajam. Follow-up: 'Dalam pengalaman Ibu, perusahaan Indonesia lebih sering gagal karena mengabaikan perspektif yang mana?'"}, {"q": "Di importance–performance matrix, zona 'excess?' menyarankan realokasi sumber daya dari faktor yang kinerjanya tinggi tetapi tidak penting bagi pelanggan. Namun kadang kelebihan itu justru ciri khas yang membedakan brand. Bagaimana membedakan excess yang aman dipangkas dari excess yang diam-diam menjadi identitas?", "guide": "Mengapa menarik: mempersoalkan sisi paling kontroversial dari matrix, tanda baca '?' pada zona excess memang disengaja penulisnya. Contoh diskusi: pelayanan berlebih ala restoran Jepang yang 'tidak diminta' pelanggan tetapi jadi reputasi. Follow-up: 'Bagaimana menguji secara murah apakah pelanggan diam-diam menghargai faktor itu?'"}],
          source: { kind: "ppt", label: "Slide Pertemuan 1" },
...
lalu <em>functional strategy</em> (tiap fungsi mendukung bagaimana). Dua kata kunci: <em>correspondence</em>, yaitu harus ada hubungan yang jelas, eksplisit, dan logis antara strategi fungsional dengan keputusan-keputusan di dalam
fungsi; dan <em>coherence</em>, yaitu semua keputusan harus saling melengkapi dan menguatkan, tidak menarik operasi ke
...
<em>Order winners</em>: faktor yang secara langsung dan signifikan memenangkan bisnis; semakin baik kinerjanya, semakin
banyak order masuk. <em>Order qualifiers</em> adalah "tiket masuk": mungkin bukan penentu kemenangan, tetapi di bawah level
...
(kondisi kotor langsung membuat produk dicoret), sedangkan kecepatan penyajian bisa jadi order winner. Perhatikan juga bahwa posisi produk
pada <em>product/service life cycle</em> menggeser objective yang relevan.</li>
<li><strong>Bottom-up</strong>, strategi yang muncul dari bawah: banyak organisasi bergerak ke arah strategis tertentu
...
supply chain, manajemen kapasitas). Kegagalan yang umum: tiap keputusan bagus sendiri-sendiri, tetapi bersama-sama
menarik operasi ke arah yang berbeda-beda.</p>
<h4 class="sub-h">Contoh nyata tiap perspektif (dari slide dosen)</h4>
<div class="case-box"><p><strong>📌 Top-down pada grup jasa percetakan:</strong> perhatikan bagaimana strategi
...
<p><strong>📌 Inside-out pada Micraytech:</strong> perusahaan sistem metrologi (bagian dari Micray Group) yang melayani
...
dengan <em>operations capabilities</em> (apa yang operasi mampu). Idealnya keduanya berada pada "line of fit", yaitu kondisi selaras. Titik A menggambarkan keselarasan di level rendah (pasar tidak menuntut banyak, operasi juga biasa saja);
...
<li><strong>Urgent-action</strong>: penting bagi pelanggan tetapi kinerja di bawah kompetitor; perbaiki segera.</li>
<li><strong>Zona excess</strong>: kinerja tinggi pada faktor yang tidak penting. Pertanyaannya, apakah sumber daya di sini
...
<ul>
<li><strong>Zona urgent action</strong> mencakup <em>price/cost</em> dan <em>communications</em>, yaitu faktor yang penting bagi pelanggan
tetapi kinerjanya kalah dari kompetitor → prioritas perbaikan nomor satu.</li>
...
<li><strong>Zona excess</strong>: <em>documentation</em>, kinerjanya bagus tetapi tidak penting bagi pelanggan →
...
<strong>order winners</strong> berbentuk garis naik, semakin baik kinerja, semakin besar manfaat kompetitifnya, tanpa
batas; <strong>qualifiers</strong> berbentuk kurva S, di bawah <em>qualifying level</em> sangat merugikan, tetapi
setelah melewatinya manfaat tambahan mendatar (percuma berlebihan); <strong>less important factors</strong> nyaris
...
<em>availability</em> (barang harus tersedia); qualifier: price & range; objectives dominan: <strong>speed,
...
Alat analisisnya: operations strategy matrix (line of fit) dan importance–performance matrix (4 zona prioritas).</div>`
        },
        {
          ...
          questions: [{"q": "Franz Colruyt memangkas biaya sampai meniadakan kantong belanja, meredupkan lampu, dan mematikan musik, dan pelanggannya menerima karena janjinya memang harga termurah. Di budaya belanja Indonesia yang sosial dan mementingkan layanan, seberapa jauh cost-cutting yang terlihat pelanggan bisa diterima, dan apa contoh batas yang pernah dilanggar peritel lokal?", "guide": "Mengapa menarik: menguji transferabilitas strategi lintas budaya. Tema yang pas dengan bagian operasi global. Follow-up: 'Apakah cost leadership di Indonesia menuntut biaya rendah yang tidak terlihat pelanggan (back office) alih-alih yang terlihat?'"}, {"q": "Dari enam alasan globalisasi, mana yang menurut Ibu paling realistis menjadi pintu masuk UMKM Indonesia ke pasar global, dan kesalahan apa yang paling sering dilakukan perusahaan lokal di langkah internasional pertamanya?", "guide": "Mengapa menarik: menurunkan kerangka besar (6 alasan go-global) ke aksi konkret untuk skala UMKM, konteks yang sangat Indonesia. Catat jawabannya untuk bekal proyek tim. Follow-up: 'Lebih baik mulai dari ekspor, lisensi, atau ikut marketplace global seperti Alibaba?'"}],
          source: { kind: "ppt", label: "Slide Pertemuan 1" },
          body: `<p><strong>Competitive advantage</strong> berarti menciptakan
sistem yang punya keunggulan unik atas kompetitor. Bagaimana operasi bisa menyumbangkannya? Lewat tiga strategi, dan cara terbaik memahaminya adalah lewat kisah perusahaan nyata:</p>
...
lewat produk sarung tangan paling mutakhir; Walt Disney Magic Kingdom menjual <em>experience differentiation</em>: yang dibeli pengunjung adalah pengalamannya, bukan wahananya; Hard Rock Cafe menjual "dining experience", bukan
sekadar makanan.</li>
...
<h4 class="sub-h">Enam alasan perusahaan melakukan ekspansi global</h4>
...
cost leadership (murah bukan berarti kualitas rendah), dan response (flexibility + reliability + timeliness). Enam alasan
...
<p>Implikasinya bagi operations manager: hampir semua dari 10 keputusan OM dieksekusi berbeda untuk jasa. Lokasi harus dekat pelanggan (bukan dekat bahan baku), persediaan tidak bisa jadi penyangga permintaan, dan penjadwalan
harus melayani permintaan seketika.</p>
<h4 class="sub-h">Tiga variabel produktivitas dan penyumbang terbesarnya</h4>
...
kerja lebih keras (labor) atau mesin lebih mahal (capital), melainkan <em>keputusan manajemen yang lebih baik</em>: persis yang sedang Anda pelajari di mata kuliah ini.</p>
...
bertanda 📖.</p>
<h4 class="sub-h">Kasus pembuka bab: Boeing 787 Dreamliner</h4>
...
masing-masing membuat bagian pesawat seperti sayap, badan, dan sistem, lalu mengirimkannya ke fasilitas perakitan akhir Boeing
di Everett, Washington.</p>
<p>Mengapa rumit-rumit begitu? Ada logika strategisnya: teknologi kolaboratif memungkinkan tiap mitra mengerjakan
keahlian terbaiknya; risiko dan biaya pengembangan terbagi; dan, yang paling cerdas, negara yang industri
...
pasar. Bedakan international business (terlibat lintas negara) dengan MNC (keterlibatan ekstensif).</div>`
        },
        {
          ...
          questions: [{"q": "Banyak mission statement perusahaan Indonesia terdengar bisa dipakai perusahaan mana pun, generik dan tidak memberi fokus. Dari pengalaman Ibu, apa tanda paling jelas bahwa sebuah mission statement benar-benar 'hidup' dan memengaruhi keputusan operasi harian, bukan sekadar pajangan dinding?", "guide": "Mengapa menarik: semua orang pernah melihat mission statement pajangan. Pertanyaan ini mengubahnya jadi diskusi tentang mekanisme, bukan retorika. Tes praktis yang bisa muncul: apakah karyawan lini depan bisa menyebutkan mission-nya? apakah pernah ada keputusan yang dibatalkan karena bertentangan dengan mission? Follow-up: 'Bagaimana menurunkan mission ke KPI operasional tanpa kehilangan maknanya?'"}, {"q": "Buku menyebut perusahaan biasanya mengimplementasikan kombinasi differentiation, cost, dan response, tetapi Porter memperingatkan bahaya 'stuck in the middle'. Bagaimana membedakan kombinasi yang sehat (seperti IKEA yang murah sekaligus khas) dari perusahaan yang sebenarnya kehilangan arah?", "guide": "Mengapa menarik: mempertemukan dua pandangan teori yang tampak bertentangan (Heizer vs Porter). Level diskusi yang menunjukkan bacaan luas. Kuncinya kemungkinan: kombinasi sehat ditopang sistem aktivitas yang koheren; stuck in the middle terjadi saat aktivitas saling meniadakan. Follow-up: 'Sinyal operasional apa yang menandakan perusahaan mulai stuck in the middle?'"}],
          source: { kind: "book", label: "Buku HRM bab 2" },
...
mengidentifikasi mission untuk memuaskan kebutuhan pelanggan. Menyusun strategi yang baik itu sulit, tetapi jauh lebih
...
leadership, response, dan operations manager yang menerjemahkannya jadi tugas nyata.</div>`
        },
        {
          ...
          questions: [{"q": "Kalau dianalisis dengan five forces, industri kopi kekinian Indonesia tampak sangat tidak menarik: entry mudah, substitusi banyak, pelanggan mudah pindah. Namun pemain dan investor terus berdatangan. Apakah ini berarti analisis five forces melewatkan sesuatu, atau para pemain itu yang keliru membaca industrinya?", "guide": "Mengapa menarik: menguji alat analisis klasik dengan anomali pasar lokal yang semua orang lihat sehari-hari. Kemungkinan jawaban yang memancing diskusi: five forces memotret rata-rata industri, bukan peluang pemain dengan kapabilitas unik (resources view); atau ekspektasi exit/akuisisi yang menggerakkan investor. Follow-up: 'Alat apa yang sebaiknya melengkapi five forces sebelum keputusan masuk industri?'"}, {"q": "Perpindahan fase product life cycle menuntut perubahan operasi yang besar, dari fleksibilitas ke kontrol biaya. Namun di dalam perusahaan, sinyal pergeseran fase sering terlambat disadari. Indikator operasional apa yang biasanya muncul paling awal ketika produk mulai bergeser dari growth ke maturity?", "guide": "Mengapa menarik: slide memberi tabel per fase tetapi tidak membahas transisi antar-fase, padahal di situlah perusahaan gagal. Kandidat indikator untuk diskusi: melambatnya repeat-order growth, menyempitnya margin, menumpuknya persediaan, perang diskon kompetitor. Follow-up: 'Siapa yang seharusnya memiliki tanggung jawab memantau sinyal ini, marketing atau operasi?'"}],
          source: { kind: "book", label: "Buku HRM bab 2" },
...
<ul>
<li><strong>Resources view</strong> bertolak dari sumber daya: apakah strategi yang direncanakan <em>kompatibel</em>
...
substitusi</em> yang bisa menggantikan Anda. Semakin kuat kelima kekuatan itu, semakin sulit industri tersebut.</li>
</ul>
[[visual:fiveForces]]
<p>Selain lingkungan kompetitif, perusahaan juga beroperasi dalam sistem dengan banyak faktor eksternal lain seperti ekonomi, hukum, dan budaya, yang memengaruhi penyusunan dan eksekusi strategi, sehingga lingkungan harus terus dipindai.</p>
...
seiring teknologi dan globalisasi, sehingga kini bisa membangun pesawat dari serat karbon dengan supply chain global.
<em>Microsoft</em>: dipaksa beradaptasi cepat oleh prosesor yang semakin kencang, bahasa pemrograman baru, preferensi
...
<p>Semakin menyeluruh analisis dan pemahaman atas faktor eksternal dan internal, semakin besar kemungkinan perusahaan
...
posisi produk di life cycle mengubah prioritas operasi, strategi yang baik selalu dinamis.</div>`
        },
        {
          ...
          questions: [{"q": "Activity map Southwest tampak elegan setelah selesai, semua aktivitasnya saling mengunci. Namun bagaimana proses MENEMUKAN kombinasi seperti itu dari awal? Apakah sistem aktivitas yang koheren bisa dirancang di atas kertas, atau selalu hasil evolusi dan trial-and-error bertahun-tahun?", "guide": "Mengapa menarik: pertanyaan tentang proses penciptaan strategi, bukan hasil akhirnya. Ini wilayah yang jarang dibahas buku teks dan biasanya dijawab dosen dari pengalaman. Follow-up: 'Kalau evolutif, apa peran manajemen: merancang, atau menyeleksi dan memperkuat pola yang muncul (bottom-up)?', sekaligus menghubungkan ke 4 perspektif strategi."}, {"q": "Hampir semua perusahaan rutin membuat SWOT, tetapi sedikit yang keputusannya benar-benar berubah karena SWOT. Dari yang Ibu amati, apa yang membedakan organisasi yang SWOT-nya mengoreksi strategi dari yang sekadar mengisi template tahunan?", "guide": "Mengapa menarik: semua mahasiswa MBA pernah menulis SWOT. Pertanyaan ini menyinggung pengalaman bersama dengan jujur. Kunci dari slide yang bisa diangkat: buku menyebut mission & strategi harus 'dievaluasi ulang' setelah SWOT, langkah yang paling sering dilewati. Follow-up: 'Apakah sebaiknya SWOT disusun oleh orang dalam yang paham konteks, atau pihak luar yang bebas kepentingan?'"}],
          source: { kind: "book", label: "Buku HRM bab 2" },
...
<li><em>Layanan penumpang terbatas tetapi ramah</em>: tanpa makanan mewah, "bags fly free", tanpa transfer bagasi;</li>
...
Keunggulan yang tahan lama datang dari <em>sistem aktivitas</em>, bukan satu trik.</div>`
        },
        {
          ...
          questions: [{"q": "Buku mencatat separuh perjanjian outsourcing gagal, dan skor kepuasan pelanggan turun ketika layanan pelanggan di-outsource, tetapi praktiknya terus meluas. Menurut Ibu, kegagalan sebesar itu bersumber dari cacat konsepnya atau selalu dari eksekusinya? Dan kapan sinyal bahwa suatu aktivitas sebaiknya ditarik kembali (insourcing)?", "guide": "Mengapa menarik: memakai statistik mengejutkan dari buku sebagai pintu masuk ke diskusi keputusan nyata. Follow-up: 'Apakah ada aktivitas yang menurut Ibu tidak boleh di-outsource apa pun alasannya?'. Jawabannya biasanya menyentuh core competency dan titik kontak pelanggan."}, {"q": "Theory of comparative advantage menjadi dasar outsourcing ke negara berupah rendah. Namun kalau AI dan otomasi membuat biaya tenaga kerja semakin tidak relevan, apakah keunggulan komparatif negara seperti Indonesia akan terkikis, dan keunggulan relatif baru apa yang harus kita bangun dari sekarang?", "guide": "Mengapa menarik: mempertemukan teori ekonomi klasik dengan disrupsi AI. Pertanyaan berbobot kebijakan yang relevan untuk semua karier. Kandidat jawaban: bergeser dari 'murah' ke pasar domestik besar, sumber daya alam hilirisasi, dan talenta digital. Follow-up: 'Untuk anak-anak kami yang masuk dunia kerja 10 tahun lagi, keterampilan operasi apa yang paling tahan otomasi?'"}],
          source: { kind: "book", label: "Buku HRM bab 2" },
          body: `<p>Konsekuensi logis dari core competencies: kalau ada
aktivitas yang <em>bukan</em> kekuatan inti Anda, mengapa tidak diserahkan ke pihak yang lebih ahli?
Itulah outsourcing, tetapi seperti akan kita lihat, keputusannya tidak sesederhana itu.</p>
<h4 class="sub-h">Definisi outsourcing dan kondisi yang tepat untuk menerapkannya</h4>
<p><strong>Outsourcing</strong> = memindahkan aktivitas yang secara tradisi dikerjakan internal ke pemasok eksternal.
Saat organisasi menyusun mission dan strategi, mereka mengidentifikasi kekuatannya (<em>core competencies</em>) dan mempertahankannya di dalam. Sebaliknya, <em>non-core activities</em> (yang bisa jadi porsi besar dari total
bisnis) adalah kandidat baik untuk di-outsource. Outsourcing bukan konsep baru. Ia perpanjangan dari praktik lama
subkontrak, tetapi cakupannya terus meluas seiring keahlian pemasok yang semakin spesialis, biaya komunikasi yang semakin
murah, dan tekanan untuk fokus.</p>
<h4 class="sub-h">Landasan ekonomi: theory of comparative advantage</h4>
<p>Mengapa outsourcing lintas negara masuk akal secara ekonomi? Jawabannya ada pada teori klasik ekonomi, <strong>theory of comparative advantage</strong>: negara-negara diuntungkan bila <em>berspesialisasi pada (dan
...
<h4 class="sub-h">Risiko outsourcing yang perlu diantisipasi</h4>
...
<h4 class="sub-h">Alat bantu pemilihan penyedia: factor-rating method</h4>
...
teorinya comparative advantage. Namun waspada: ±50% perjanjian outsourcing gagal karena perencanaan buruk. Hitung semua biaya, dan pakai factor-rating method agar keputusan objektif. Tren balik arah: reshoring.</div>`
        },
        {
          heading: "Empat Opsi Strategi Operasi Global",
          questions: [{"q": "McDonald's menyesuaikan menu di tiap negara, tetapi ke mana pun kita pergi, McD tetap terasa 'McD'. Di mana sebenarnya batas antara multidomestic strategy yang sungguhan dengan sekadar lokalisasi kosmetik di atas operasi yang sepenuhnya standar? Keputusan operasi apa yang jadi penentunya?", "guide": "Mengapa menarik: membongkar contoh yang tampak sederhana di slide. Jawabannya menyentuh keputusan mana yang didesentralisasi (menu, pemasok lokal) vs yang tetap terpusat (proses, standar kualitas, sistem). Follow-up: 'Apakah lokalisasi menu tanpa desentralisasi keputusan operasi masih layak disebut multidomestic?'"}, {"q": "Untuk brand Indonesia yang mau ekspansi regional (Kopi Kenangan, J.CO, Erigo) kuadran strategi global mana yang realistis sebagai pintu masuk pertama, dan kesalahan apa yang paling sering dilakukan perusahaan Asia Tenggara saat naik kelas dari international ke multidomestic?", "guide": "Mengapa menarik: meminta dosen menerapkan matriks 2×2 pada kasus lokal yang belum ada di buku mana pun. Diskusi yang hasilnya orisinal. Catat jawabannya: bisa jadi bahan proyek tim presentasi. Follow-up: 'Kapabilitas organisasi apa yang harus dibangun sebelum membuka operasi di negara kedua?'"}],
          source: { kind: "book", label: "Buku HRM bab 2" },
          body: `<p>Ketika perusahaan memutuskan go-international, ia harus memilih
<em>cara</em> hadir di panggung global. Heizer memetakan empat pilihan strategi pada sebuah matriks dua sumbu, dan memahami matriks ini jauh lebih penting daripada menghafal empat namanya.</p>
<h4 class="sub-h">Dua sumbu penyusun matriks</h4>
<p>Sumbu <strong>vertikal (cost reduction)</strong> mengukur seberapa besar strategi itu mengejar efisiensi biaya
lewat skala dan standardisasi global. Sumbu <strong>horizontal (local responsiveness)</strong> mengukur seberapa
besar strategi itu menuntut respons cepat dan/atau diferensiasi untuk pasar lokal. Tugas operations manager adalah
mengetahui di mana perusahaannya harus diposisikan pada matriks ini.</p>
...
<em>ekspor dan lisensi</em> dengan sedikit perubahan pada operasi yang ada. Ini strategi yang <em>paling mudah</em>: ekspor menuntut perubahan minimal, dan perjanjian lisensi melimpahkan sebagian besar risiko ke pemegang lisensi, tetapi juga <em>paling tidak menguntungkan</em>: keunggulan biayanya kecil, responsivitas lokalnya pun rendah.
Biasanya jadi pintu masuk pertama perusahaan ke pasar dunia.</li>
<li><strong>Multidomestic strategy (cost rendah, responsiveness tinggi)</strong>: wewenang <em>terdesentralisasi</em>, sehingga
...
<li><strong>Global strategy (cost tinggi, responsiveness rendah)</strong>: <em>sentralisasi</em> tinggi, dengan kantor
pusat yang mengoordinasi standardisasi dan pembelajaran antar-pabrik sehingga tercipta skala ekonomi. Cocok saat fokus
...
<li><strong>Transnational strategy (cost tinggi, responsiveness tinggi)</strong>: menggabungkan <em>keduanya</em>, yaitu
...
<h4 class="sub-h">Penutup bab: benang merah pembahasan</h4>
...
<div class="key-box"><strong>💡 Intinya:</strong> Hafalkan matriksnya, bukan sekadar namanya: sumbu cost reduction ×
...
keduanya sekaligus (tersulit).</div>`
  ...
  flashcards: [
    ...
    { session: 1, front: "Empat zona pada importance–performance matrix?", back: "Appropriate (memuaskan), Improve (di bawah batas layak), Urgent-action (penting bagi pelanggan tetapi kalah dari kompetitor), Excess? (kinerja tinggi tetapi tidak penting bagi pelanggan)." },
    ...
    { session: 1, front: "Apa itu model bisnis Ecosystem? Beri contoh.", back: "Pelanggan dijual rangkaian produk/jasa yang saling terkait, yang nilainya meningkat seiring semakin banyak produk yang dimiliki, mis. ekosistem Apple (iPhone + Watch + Mac + iCloud) atau Google." },
    ...
    { session: 2, front: "Jelaskan international strategy.", back: "Penetrasi pasar global lewat ekspor & lisensi. Paling mudah (sedikit perubahan operasi, risiko lisensi di pihak licensee) tetapi paling tidak menguntungkan: responsivitas lokal rendah dan keunggulan biaya kecil." },
  ...
  quizzes: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 1,
          explain: "Order qualifiers bukan penentu utama kemenangan, tetapi di bawah level 'qualifying' organisasi terdiskualifikasi dari pertimbangan pelanggan."
        },
        {
        ...
        },
        {
          ...
          answer: 2,
          explain: "Zona urgent-action = penting bagi pelanggan tetapi performa di bawah kompetitor → kandidat perbaikan segera."
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 2,
          explain: "Southwest justru menawarkan layanan penumpang yang terbatas (tetapi ramah), tanpa nomor kursi, tanpa transfer bagasi, demi biaya rendah."
        },
        {
        ...
        },
        {
          ...
          answer: 1,
          explain: "Multidomestic (contoh: Heinz). Respons lokal maksimal, tetapi hampir tanpa keunggulan biaya. 'Ekspor talenta manajemen & proses, bukan produknya.'"
        },
        {
