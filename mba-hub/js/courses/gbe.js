...
window.MBA_COURSES.gbe = {
  meta: {
    ...
    status: "Silabus baru Prof. Sony Warsono · urutan topik diperbarui"
  },
  course: {
  ...
  materialMap: [
    ...
    { file: "20260223_GBE Natural Environment 2022_Pak Andhika.pdf", sessions: [9], part: "Seluruh deck",
    ...
    { file: "20260224_Social Environment_MBA UGM 2026_Desideria.pptx", sessions: [6], part: "Seluruh deck",
      why: "Silabus = \"Lingkungan Sosial dan Budaya\". Prefiks 0224 = hari ke-2 → 1 September 2026.", confidence: "pasti" },
    { file: "20260224_GBE Political Environment Sem 2_Hempri Suyatna.pptx", sessions: [7], part: "Seluruh deck",
      why: "Silabus = \"Lingkungan Politik Nasional dan Internasional\". Prefiks 0224 = hari ke-2.", confidence: "pasti" },
    { file: "20260225_GBE-demographical environment-Ibu Amelia.pdf", sessions: [5], part: "Seluruh deck",
      why: "Silabus = \"Lingkungan Demografi\". Prefiks 0225 = hari ke-3 → 2 September 2026.", confidence: "pasti" },
    { file: "20260226_NEW. GBE MMTech_Env_SKW_FD_Pak Wirawan.pdf", sessions: [8], part: "Seluruh deck",
      why: "Silabus = \"Lingkungan Teknologi\". Prefiks 0226 = hari ke-4 → 3 September 2026.", confidence: "pasti" },
    { file: "20260226_Ferry MM - Hukum dan Hukum Bisnis (Mahasiswa).pptx", sessions: [3], part: "Seluruh deck",
      why: "Silabus = \"Lingkungan Hukum Bisnis Indonesia\". Prefiks 0226 = hari ke-4.", confidence: "tinggi" },
    { file: "(belum ada)", sessions: [4, 10], part: "Lingkungan Hukum Bisnis Internasional &amp; Lingkungan Pemerintahan",
  ...
  sessions: [
    ...
    { id: 3, date: "2026-08-31", dateLabel: "31 Agustus 2026 · Hari 1", topic: "Lingkungan Hukum Bisnis Indonesia",
    ...
    { id: 4, date: "2026-09-01", dateLabel: "1 September 2026 · Hari 2", topic: "Lingkungan Hukum Bisnis Internasional",
    ...
    { id: 5, date: "2026-09-01", dateLabel: "1 September 2026 · Hari 2", topic: "Lingkungan Demografi",
    ...
    { id: 6, date: "2026-09-02", dateLabel: "2 September 2026 · Hari 3", topic: "Lingkungan Sosial & Budaya",
    ...
    { id: 7, date: "2026-09-02", dateLabel: "2 September 2026 · Hari 3", topic: "Lingkungan Politik (Nasional & Internasional)",
    ...
    { id: 8, date: "2026-09-03", dateLabel: "3 September 2026 · Hari 4", topic: "Lingkungan Teknologi",
    ...
    { id: 9, date: "2026-09-03", dateLabel: "3 September 2026 · Hari 4", topic: "Lingkungan Alami (Natural)",
    ...
    { id: 10, date: "2026-09-03", dateLabel: "3 September 2026 · Hari 4", topic: "Lingkungan Pemerintahan",
