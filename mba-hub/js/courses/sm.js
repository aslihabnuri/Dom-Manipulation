...
window.MBA_COURSES.sm = {
  meta: {
    ...
    lecturerNote: "Silabus baru 2026 · kamu di Kelompok 3",
    sks: 3,
    sessionsTotal: 12,
    hasBook: true,
    tools: [],
  ...
  course: {
    ...
    references: [
      ...
      { code: "HIA", text: "Handoko, T. Hani, Indarti, N. & Almahendra, R. (2014), Manajemen dalam Berbagai Perspektif, Erlangga. — buku dosen sendiri" }
    ],
    objectives: [
  ...
  myGroupInfo: {
    number: 3,
    members: ["Tifani Puspita", "Dara Astrini Rahayu K", "Richy Fatma Salsabila", "Happy Dinithasari", "Aslih Abnuri (kamu)"],
    duties: [
  ...
  materialMap: [
    ...
    { file: "Grant (2010) Ch.4 — AirAsia", sessions: [4],
      part: "Teaching case AirAsia — Kelompok 3 (kelompok kamu) presentasi kasus",
  ...
  sessions: [
    {
      ...
      summary: [
        {
          heading: "Yang Akan Terjadi Malam Ini — dan Keputusan yang Harus Kamu Ambil",
...
will be done in the first lecture."</em> Artinya <strong>malam ini kelompok dan jadwal presentasi ditetapkan</strong> —
keputusan yang mengikat sampai akhir semester. Datang sudah tahu peta jalannya.</p>
<h4 class="sub-h">Empat komponen nilai — dan pergeseran besarnya</h4>
...
dari mata kuliah lain Anda — di OTM partisipasi hanya 10% dan proyek tim 40%; di Business Ethics partisipasi justru
30%. Di SM, <em>partisipasi hanya 10%</em>, jadi energi terbesar harus masuk ke ujian dan makalah individu. Tetapi
hati-hati: silabus juga menegaskan <em>"Students failing to participate in their teams will lose the marks for that
piece of work"</em> — tidak berkontribusi di kelompok = kehilangan nilai bagian itu.</p>
...
dikomentari dan dikritik. Mahasiswa yang tidak presentasi wajib mengajukan pertanyaan sebelum sesi — dan
<em>pertanyaan itulah yang menjadi dasar nilai partisipasi</em>.</li>
...
<h4 class="sub-h">Learning Diary — kewajiban yang paling mudah dilupakan</h4>
...
<h4 class="sub-h">Term Paper — 40% nilai, mulai pikirkan malam ini</h4>
...
<div class="key-box"><strong>💡 Bawa ke kelas malam ini:</strong> (1) preferensi sesi presentasi kelompok — makin awal
makin ringan bebannya di masa UTS; (2) 2–3 kandidat perusahaan untuk term paper; (3) pertanyaan tentang tanggal
...
<em>Peringatan dosen:</em> saat menjelaskan alternatif, <strong>JANGAN</strong> menyertakan argumen pro/kontra —
itu mengaburkan kejelasan dan akan berulang di bagian Issues.</li>
...
kasus Anda; dosen menulis panduannya sendiri, jadi ia akan mencarinya.</div>`
    ...
    },
    {
      ...
      summary: [
        {
          heading: "Apa Sebenarnya \"Strategi\" Itu?",
...
<p>Tapi definisi itu terlalu mudah dihafal tanpa dipahami. Yang penting adalah kalimat berikutnya:
...
(Sesi 6), tapi diperkenalkan sejak Bab 1 — dan sering menjadi soal ujian:</p>
...
<h4 class="sub-h">Mengapa keunggulan bisa bertahan?</h4>
...
<li><strong>Sistem aktivitas yang saling mengunci</strong> — pesaing bisa meniru satu aktivitas, tapi tidak seluruh
...
<em>reactive/adaptive strategy</em>) adalah bagian yang muncul sebagai respons terhadap perkembangan tak terduga —
teknologi baru, langkah pesaing, perubahan regulasi, krisis.</p>
...
tanda manajemen tidak memperhatikan pasar.</div>`
        ...
        {
          heading: "Strategi vs Business Model — Beda yang Sering Tertukar",
          source: { kind: "book", label: "Thompson & Strickland Bab 1" },
...
rusak</strong> — proposisi nilainya menarik, tapi struktur biayanya tidak memungkinkan untung. Banyak startup
...
berkelanjutan?</strong> Makin besar dan makin tahan lama keunggulan yang dihasilkan, makin kuat strategi itu.
...
Strategi yang terdengar cerdas tapi tidak memperbaiki angka bukan strategi yang menang.</li>
</ul>
...
test (berkelanjutan?) · Performance test (angka membaik?). Strategi menang harus lulus <em>ketiganya</em>.</div>`
        },
        {
          ...
          source: { kind: "book", label: "Thompson & Strickland Bab 1" },
          body: `<p>Bagian penutup bab menjawab pertanyaan "kenapa mata kuliah ini ada". Tiga alasannya:</p>
<ul>
...
eksekusi.</p>
<h4 class="sub-h">Framework yang dipresentasikan hari ini: Eisenhower Matrix</h4>
<p>Kelompok 1 membawakan <strong>Eisenhower Matrix</strong> sebagai framework pendamping Bab 1. Matriks ini
mengklasifikasi pekerjaan pada dua sumbu — <em>penting</em> vs <em>mendesak</em>:</p>
[[visual:smEisenhower]]
<p>Relevansinya dengan strategi: <strong>pekerjaan strategis hampir selalu penting tapi tidak mendesak</strong>
...
strategis (penting–tidak mendesak) selalu terancam tergeser.</div>`
    ...
    { id: 4, date: "2026-09-12", dateLabel: "12 September 2026", topic: "Evaluating a Company's External Environment",
      ...
      readings: ["Thompson & Strickland Bab 3", "Grant (2010) Ch.4 — AirAsia"], caseStudy: "AirAsia — KELOMPOK 3 (kamu!)",
      groupDuty: "⭐ KELOMPOK 3 (KAMU): Chapter Presentation Bab 3 + Case Presentation AirAsia", summary: null },
    ...
    { id: 9, date: "2026-11-07", dateLabel: "7 November 2026", topic: "Building an Organization Capable of Good Strategy Execution",
      ...
      groupDuty: "⭐ KELOMPOK 3 (KAMU): Chapter Presentation Bab 10 + Framework: 4 Disciplines of Execution (4DX)", summary: null },
  ...
  cases: [
    {
      ...
      sections: [
        { heading: "Satu Ringgit untuk Sebuah Maskapai",
...
Fly."</em></p>
<p>Delapan tahun kemudian, pada 2009, AirAsia dinobatkan Skytrax sebagai <em>World's Best Low-Cost Airline</em> —
gelar yang kemudian dipertahankannya bertahun-tahun berturut-turut. Maskapai yang dibeli seharga satu ringgit itu
...
<h4 class="sub-h">4. Tanpa embel-embel — tetapi dijual kembali</h4>
...
<em>associate airlines</em> — Thai AirAsia (2003), Indonesia AirAsia (2004), kemudian Filipina, India, dan Jepang —
dengan mitra lokal sebagai pemegang saham mayoritas, sementara AirAsia menyediakan merek, sistem, dan keahlian
...
menjadi relatif kecil.</p>` },
        ...
        { heading: "Ancaman yang Mengintai",
...
mirip.</li>
<li><strong>Petahana melawan balik.</strong> Maskapai penuh layanan mendirikan anak usaha berbiaya rendah sendiri —
Singapore Airlines lewat Scoot dan Tiger, Qantas lewat Jetstar, Malaysia Airlines lewat Firefly. Mereka membawa
...
menyulitkan pengendalian biaya yang menjadi inti keunggulan.</li>
        ...
        { heading: "Epilog: Apa yang Terjadi Sesudahnya",
...
armada yang menganggur tetap menanggung biaya sewa, sementara utilisasi tinggi — sumber keunggulan biaya — berubah
menjadi tidak relevan ketika pesawat tidak boleh terbang.</p>
<p>Grup ini kemudian melakukan restrukturisasi besar, berganti nama menjadi <strong>Capital A</strong> pada 2022,
dan bergeser memposisikan diri bukan lagi semata maskapai melainkan perusahaan berbasis digital dan logistik —
dengan airasia Super App, layanan pembayaran BigPay, dan unit kargo Teleport. Pada saat yang sama, entitasnya masuk
...
bertahun-tahun cukup untuk melindungi perusahaan dari guncangan yang meniadakan asumsi dasarnya?</em></p>` }
    ...
    },
    {
      ...
      sections: [
        { heading: "Call Center dengan 20 Pengemudi",
...
semuanya — makin banyak layanan yang dibayar lewat GoPay, makin mahal biaya psikologis pengguna untuk pindah ke
pesaing.</p>
...
memperdalam keunggulan</strong>.</p>` }
    ...
    },
    {
      ...
      sections: [
        { heading: "Celah di Antara Rp5.000 dan Rp50.000",
...
ruang kosong di antaranya: kopi susu berbahan baku layak dengan harga sekitar <strong>Rp18.000–25.000</strong> —
terjangkau bagi kelas pekerja perkotaan yang ingin naik kelas dari kopi saset tetapi menganggap Starbucks terlalu
...
pendanaan Seri C.</p>` },
        { heading: "Ketika Semua Orang Menyalin Formatnya",
...
pesaing. Masing-masing punya daya tahan yang berbeda.</p>` }
  ...
  flashcards: [
    ...
    { session: 1, front: "Apa itu Learning Diary dan apa bedanya dengan catatan kuliah?", back: "Esai reflektif pendek berisi argumen utama & poin penting diskusi PLUS interpretasi dan pertanyaan sendiri — BUKAN catatan kuliah mentah. Wajib dibuat setiap sesi dan dibagikan di grup WhatsApp kelas." },
    ...
    { session: 2, front: "Apa beda strategi dan business model?", back: "Strategi menjawab BAGAIMANA BERSAING dan menang. Business model menjawab APAKAH cara itu MENGHASILKAN UANG — terdiri dari customer value proposition dan profit formula." },
    ...
    { session: 2, front: "Apa itu Eisenhower Matrix dan relevansinya dengan strategi?", back: "Matriks dua sumbu: penting vs mendesak. Relevansinya: pekerjaan strategis hampir selalu PENTING tapi TIDAK MENDESAK (kuadran 2), sehingga terus kalah oleh urusan mendesak-tidak-penting — alasan struktural mengapa banyak perusahaan tak sempat berstrategi." }
  ],
