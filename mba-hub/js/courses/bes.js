...
window.MBA_COURSES.bes = {
  ...
  sessions: [
    { id: 1, date: "2026-08-15", dateLabel: "15 Agustus 2026", topic: "Pengantar & Introducing Business Ethics",
      ...
      summary: [
        {
          heading: "Definisi Business Ethics dan Alasan Pentingnya",
...
<h4 class="sub-h">Definisi yang dipakai dosen di kelas</h4>
...
[[visual:besLawEthics]]
<p>Karena itu sebuah perusahaan bisa <strong>legal tetapi tidak etis</strong>: misalnya mematuhi ambang batas emisi
tetapi tetap menghasilkan polusi yang sebenarnya bisa dihindari, atau memakai skema pajak yang sah menurut huruf
hukum tetapi mempertanyakan tanggung jawab sosialnya. Sebaliknya, sebagian isu hukum bukan dilema moral sama sekali
...
<p><strong>Stakeholder sekunder</strong> tidak bertransaksi langsung tetapi memengaruhi dan dipengaruhi: pemerintah
...
<li><strong>Socially progressive:</strong> tetap mengutamakan laba, tetapi terlibat interaktif secara sosial dan positif dalam perumusan kebijakan industri.</li>
...
+ social, masing-masing dengan ukuran konkret. Peran perusahaan bergerak dari profit maximiser sampai global actor.</div>`
        },
        {
          ...
          body: `<p>Globalisasi membuat etika bisnis semakin rumit karena organisasi beroperasi lintas negara. Sebuah
...
perusahaan dan orang di semua masyarakat."</em> Namun segera disandingkan dengan posisi tandingannya:
...
manajemen puncak.</div>`
        },
        {
          ...
          source: { kind: "ppt", label: "Deck Prof. Eko Suwardi" },
          body: `<p>Pertanyaan yang tampak sederhana tetapi menjadi perdebatan panjang: ketika sebuah perusahaan
...
<h4 class="sub-h">Isu etika pada level sistemik</h4>
...
keadilan suatu undang-undang, struktur industri yang oligopolistik, atau praktik sosial yang diterima luas tetapi
...
kewajiban ekonomi dan hukumnya. Kerangka paling terkenal adalah <em>piramida Carroll</em> dengan empat lapis tanggung
...
moral?</em> Pertanyaan ini menyambung langsung diskusi "individu vs korporasi" di Sesi 1. <em>(2) Kepada siapa perusahaan
...
menurut Anda menjalankan corporate citizenship. Ingat, <strong>diskusi dan partisipasi bernilai 30%</strong> di mata
kuliah ini, bobot terbesar yang melampaui UTS maupun UAS.</div>`
        },
        {
...
(rights), dan keadilan (justice); lalu tunjukkan bila lensa yang berbeda memberi jawaban berbeda.</li>
...
multi-lensa → putusan + alternatif.</div>`
  ...
  flashcards: [
    ...
    { session: 1, front: "Beri contoh tindakan yang legal tetapi tidak etis.", back: "Mematuhi ambang batas emisi tetapi tetap menghasilkan polusi yang bisa dihindari; skema penghindaran pajak agresif yang sah menurut huruf hukum; pemasaran yang legal tetapi menyesatkan konsumen rentan." },
    ...
    { session: 1, front: "Sebutkan stakeholder sekunder sebuah perusahaan.", back: "Pemerintah (pusat/daerah/asing), komunitas lokal, masyarakat umum, media, kelompok aktivis sosial, dan kelompok pendukung bisnis, yang memengaruhi atau dipengaruhi tanpa transaksi langsung." },
    ...
    { session: 2, front: "Sebutkan empat lapis piramida CSR Carroll dari bawah ke atas.", back: "1) Economic (menghasilkan laba, fondasinya), 2) Legal (patuh hukum), 3) Ethical (melakukan yang benar meski tak diwajibkan), 4) Philanthropic (berkontribusi pada masyarakat)." },
    ...
    { session: 2, front: "Bobot penilaian mata kuliah Business Ethics?", back: "Diskusi & partisipasi 30% (bobot terbesar) · UTS 25% · UAS 25% · Tugas individu & kelompok 20%." },
