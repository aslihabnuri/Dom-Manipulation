...
window.MBA_PREP = {
  ...
  otm: {
    ...
    4: { intro: "Setelah mengetahui apa yang dibuat, sesi ini membahas bagaimana membuatnya: pemilihan tipe proses, teknologi yang dipakai, dan peran manusia di dalamnya.",
      concepts: [
    ...
    6: { intro: "Persediaan adalah uang yang berbentuk barang. Sesi ini mengajarkan berapa banyak yang harus disimpan dan kapan memesan ulang. Dua pertanyaan yang menentukan modal kerja perusahaan.",
      ...
      questions: ["Amazon (kasus sesi ini) menyimpan jutaan SKU tetapi tetap efisien. Bagaimana mereka menyiasati trade-off klasik persediaan?",
    ...
    8: { intro: "Sesi ini turun ke keputusan harian: pekerjaan mana dikerjakan lebih dulu, siapa mengerjakan apa, dan kapan. Keputusan kecil yang berdampak besar pada dependability.",
      concepts: [
        ...
        ["Aturan prioritas", "FCFS, SPT (shortest processing time), EDD (earliest due date), dan LPT, masing-masing mengoptimalkan kriteria berbeda."],
      ...
      questions: ["Alaska Airlines (kasus sesi ini) menjadwalkan awak, pesawat, dan gate sekaligus, mana batasan yang paling mengikat?",
        "Aturan SPT meminimalkan waktu tunggu rata-rata, tetapi apa kerugian etisnya bagi pesanan besar yang terus tergeser?"] },
    ...
    9: { intro: "Operasi tidak berhenti di pagar pabrik. Supply chain management mengelola seluruh jaringan dari pemasoknya pemasok sampai pelanggannya pelanggan.",
      concepts: [
        ["Make-or-buy & outsourcing", "Keputusan mana yang dikerjakan sendiri dan mana yang diserahkan ke pihak lain. Anda sudah menemuinya di materi strategi operasi."],
        ["Bullwhip effect", "Fluktuasi permintaan membesar semakin ke hulu; disebabkan batching, promosi, dan informasi yang tidak dibagikan."],
    ...
    11: { intro: "Kualitas adalah performance objective yang mendukung semuanya. Sesi ini membahas cara mendefinisikan, mengukur, dan mengendalikannya secara sistematis.",
      concepts: [
        ...
        ["Process capability", "Cp dan Cpk, yaitu ukuran apakah proses sanggup memenuhi spesifikasi."],
      ...
      questions: ["Arnold Palmer Hospital (kasus sesi ini) mengukur kualitas layanan yang sebagian besar subjektif, ukuran apa yang mereka pakai?",
        "Mengapa 'zero defects' realistis di manufaktur tetapi sulit didefinisikan di jasa?"] },
  ...
  bes: {
    3: { intro: "Sesi paling teoretis sekaligus paling penting: alat-alat berpikir untuk menilai apakah suatu keputusan bisnis dapat dibenarkan secara moral. Semua analisis kasus sesudahnya memakai teori-teori ini.",
      ...
      questions: ["Kasus Ford Pinto: perhitungan biaya-manfaat menyimpulkan tidak memperbaiki tangki bensin lebih murah daripada menanggung tuntutan. Di mana letak kesalahan moral penalaran itu?",
        "Adakah keputusan bisnis yang dibenarkan utilitarianisme tetapi dilarang oleh teori hak? Siapkan satu contoh."] },
    ...
    10: { intro: "Masyarakat sipil (LSM, komunitas, media, akademisi) kini menjadi kekuatan yang menuntut pertanggungjawaban perusahaan. Sesi ini membahas relasi yang sering bermusuhan tetapi bisa menjadi kemitraan.",
      concepts: [
    ...
    11: { intro: "Pemerintah adalah pembuat aturan main sekaligus aktor ekonomi. Sesi ini membahas relasi bisnis–negara yang penuh godaan etis.",
      concepts: [
        ...
        ["Etika perpajakan", "Penghindaran pajak yang legal vs tanggung jawab fiskal, contoh klasik 'legal tetapi tidak etis'."],
  ...
  sm: {
    ...
    4: { intro: "⭐ Sesi ini adalah giliran kelompok Anda. Bab 3 tentang analisis lingkungan eksternal, dan Kelompok 3 mempresentasikan bab ini SEKALIGUS kasus AirAsia. Persiapan harus dimulai jauh hari.",
      concepts: [
    ...
    6: { intro: "Bab 5 memperdalam lima pendekatan strategi kompetitif yang sudah diperkenalkan di Bab 1. Pembahasannya mencakup kapan masing-masing pendekatan berhasil dan kapan gagal.",
      concepts: [
    ...
    9: { intro: "⭐ Giliran kelompok Anda kembali. Bab 10 tentang membangun organisasi yang mampu mengeksekusi strategi, dan Kelompok 3 juga membawakan framework 4 Disciplines of Execution.",
      concepts: [
