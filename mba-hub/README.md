...
| MAN 6521 | General Business Environment | Prof. Dr. Sony Warsono (koordinator) | Kuliah blok 31 Agu–3 Sep, tiap lingkungan dosen berbeda, tanpa buku teks tunggal |
| MAN 5422 | Strategic Management | Dr. Rangga Almahendra / Dr. Claudius Budi Santoso | PPT belum ada — bahan bacaan TPGS bab 1–2 sudah disiapkan |
...
mba-hub/
  ...
  js/courses/sm.js      — data + bahan bacaan SM
...
(`dashboard`, `silabus`, `materi`, `jadwal`, `tugas`, `kelas`, `flashcards`, `kuis`, `catatan`).
