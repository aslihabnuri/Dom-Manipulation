...
BLOCKS = [
    ...
    ('Community Interaction Sophie Martin Official',None,None,None,None),
    ('Community Interaction Sophie Martin ID',None,None,None,None),
    ('Brand Consideration EXT','tt_bc_ext','tiktok','Brand Consideration','upper'),
    ('Brand Consideration NS',None,None,None,None),
    ('Awareness TikTok Ext','tt_aw_ext','tiktok','Awareness TikTok','upper'),
    ('Awareness TikTok Affiliate',None,None,None,None),
    ('Awareness TikTok','tt_aw_ext','tiktok','Awareness TikTok','upper'),
    ('Brand Consideration','tt_bc_ext','tiktok','Brand Consideration','upper'),
    ('Community Interaction','tt_ci_smv','tiktok','Community Interaction','upper'),
